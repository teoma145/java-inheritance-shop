...
public class Cart {
    public static void main(String[] args) {
        ...
        scanner.nextLine();
        Prodotto[] cart = new Prodotto[numeroProdotti];
        for (int i = 0; i < cart.length; i++) {
            ...
            switch (tipoProdotto.toLowerCase()) {
                case "smartphone":
                    ...
                    scanner.nextLine();
                    cart[i]= (new Smartphone(nome, marca, prezzo, iva, imei, memoria));
                    break;
                case "televisore":
                    ...
                    scanner.nextLine();
                    cart[i]=(new Televisori(nome, marca, prezzo, iva, dimensione, smart));
                    break;
                case "cuffie":
                    ...
                    cart[i]=(new Cuffie(nome, marca, prezzo, iva, colore, tipoConnessione));
                    break;
                default:
